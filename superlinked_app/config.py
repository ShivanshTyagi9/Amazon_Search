...
class Settings(BaseSettings):
    ...
    # MongoDB
    USE_MONGO_VECTOR_DB: bool = False  # If 'False',will use an InMemory vector database that requires no credentials.
    MONGO_CLUSTER_URL: str | None = None
    MONGO_CLUSTER_NAME: str = "as0"
    MONGO_DATABASE_NAME: str = "amazon-search"
